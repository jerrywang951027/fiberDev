...
import { OMNIDEF } from './tCKEscalateIssueTicketsEnglish_def.js';
import tmpl from './tCKEscalateIssueTicketsEnglish.html';
import tmpl_nds from './tCKEscalateIssueTicketsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKEscalateIssueTicketsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
