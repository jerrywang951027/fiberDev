...
import { OMNIDEF } from './gEOLeadManagementSignUpFlowEnglish_def.js';
import tmpl from './gEOLeadManagementSignUpFlowEnglish.html';
import tmpl_nds from './gEOLeadManagementSignUpFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class gEOLeadManagementSignUpFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
