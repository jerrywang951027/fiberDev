...
import { OMNIDEF } from './cONCustomNotificationsEnglish_def.js';
import tmpl from './cONCustomNotificationsEnglish.html';
import tmpl_nds from './cONCustomNotificationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCustomNotificationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
