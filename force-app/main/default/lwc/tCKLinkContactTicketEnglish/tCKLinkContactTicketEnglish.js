...
import { OMNIDEF } from './tCKLinkContactTicketEnglish_def.js';
import tmpl from './tCKLinkContactTicketEnglish.html';
import tmpl_nds from './tCKLinkContactTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKLinkContactTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
