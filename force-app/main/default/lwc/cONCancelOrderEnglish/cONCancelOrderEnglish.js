...
import { OMNIDEF } from './cONCancelOrderEnglish_def.js';
import tmpl from './cONCancelOrderEnglish.html';
import tmpl_nds from './cONCancelOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCancelOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
