...
import { OMNIDEF } from './lDMTenantLeadEnglish_def.js';
import tmpl from './lDMTenantLeadEnglish.html';
import tmpl_nds from './lDMTenantLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lDMTenantLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
