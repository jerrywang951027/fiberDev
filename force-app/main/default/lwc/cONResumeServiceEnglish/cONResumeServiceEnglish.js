...
import { OMNIDEF } from './cONResumeServiceEnglish_def.js';
import tmpl from './cONResumeServiceEnglish.html';
import tmpl_nds from './cONResumeServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONResumeServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
