...
import { OMNIDEF } from './tCKUpdateContactTicketEnglish_def.js';
import tmpl from './tCKUpdateContactTicketEnglish.html';
import tmpl_nds from './tCKUpdateContactTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKUpdateContactTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
