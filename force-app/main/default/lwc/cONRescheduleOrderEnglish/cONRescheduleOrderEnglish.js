...
import { OMNIDEF } from './cONRescheduleOrderEnglish_def.js';
import tmpl from './cONRescheduleOrderEnglish.html';
import tmpl_nds from './cONRescheduleOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONRescheduleOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
