...
import { OMNIDEF } from './cONReportLostOrStolenEnglish_def.js';
import tmpl from './cONReportLostOrStolenEnglish.html';
import tmpl_nds from './cONReportLostOrStolenEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONReportLostOrStolenEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
