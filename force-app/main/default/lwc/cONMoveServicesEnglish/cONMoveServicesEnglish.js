...
import { OMNIDEF } from './cONMoveServicesEnglish_def.js';
import tmpl from './cONMoveServicesEnglish.html';
import tmpl_nds from './cONMoveServicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONMoveServicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
