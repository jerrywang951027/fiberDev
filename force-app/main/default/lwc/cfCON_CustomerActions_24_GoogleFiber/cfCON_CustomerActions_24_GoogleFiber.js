import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCON_CustomerActions_24_GoogleFiber extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              registerPubSub() {
                pubsub.register('ticketWorklogChannel', {
                          ticket_worklog_channel: this.handleEventAction.bind(this, data.events[0],0)
                      });
