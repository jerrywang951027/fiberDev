...
import { OMNIDEF } from './cONUpdateContactEnglish_def.js';
import tmpl from './cONUpdateContactEnglish.html';
import tmpl_nds from './cONUpdateContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONUpdateContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
