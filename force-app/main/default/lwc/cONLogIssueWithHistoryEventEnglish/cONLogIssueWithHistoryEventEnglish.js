...
import { OMNIDEF } from './cONLogIssueWithHistoryEventEnglish_def.js';
import tmpl from './cONLogIssueWithHistoryEventEnglish.html';
import tmpl_nds from './cONLogIssueWithHistoryEventEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONLogIssueWithHistoryEventEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
