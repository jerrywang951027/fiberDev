...
import { OMNIDEF } from './cONCreateContactTicketWithLeadEnglish_def.js';
import tmpl from './cONCreateContactTicketWithLeadEnglish.html';
import tmpl_nds from './cONCreateContactTicketWithLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCreateContactTicketWithLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
