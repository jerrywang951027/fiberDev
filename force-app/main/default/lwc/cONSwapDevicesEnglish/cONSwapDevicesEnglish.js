...
import { OMNIDEF } from './cONSwapDevicesEnglish_def.js';
import tmpl from './cONSwapDevicesEnglish.html';
import tmpl_nds from './cONSwapDevicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONSwapDevicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
