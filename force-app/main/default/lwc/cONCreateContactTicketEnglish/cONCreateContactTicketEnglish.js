...
import { OMNIDEF } from './cONCreateContactTicketEnglish_def.js';
import tmpl from './cONCreateContactTicketEnglish.html';
import tmpl_nds from './cONCreateContactTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCreateContactTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
