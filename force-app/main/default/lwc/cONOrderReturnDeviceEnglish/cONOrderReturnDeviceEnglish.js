...
import { OMNIDEF } from './cONOrderReturnDeviceEnglish_def.js';
import tmpl from './cONOrderReturnDeviceEnglish.html';
import tmpl_nds from './cONOrderReturnDeviceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONOrderReturnDeviceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
