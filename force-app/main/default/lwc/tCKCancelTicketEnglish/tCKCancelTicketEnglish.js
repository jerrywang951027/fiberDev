...
import { OMNIDEF } from './tCKCancelTicketEnglish_def.js';
import tmpl from './tCKCancelTicketEnglish.html';
import tmpl_nds from './tCKCancelTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKCancelTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
