...
import { OMNIDEF } from './cONReturnDeviceEnglish_def.js';
import tmpl from './cONReturnDeviceEnglish.html';
import tmpl_nds from './cONReturnDeviceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONReturnDeviceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
