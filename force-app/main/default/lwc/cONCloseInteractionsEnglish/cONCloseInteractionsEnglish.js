...
import { OMNIDEF } from './cONCloseInteractionsEnglish_def.js';
import tmpl from './cONCloseInteractionsEnglish.html';
import tmpl_nds from './cONCloseInteractionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCloseInteractionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
