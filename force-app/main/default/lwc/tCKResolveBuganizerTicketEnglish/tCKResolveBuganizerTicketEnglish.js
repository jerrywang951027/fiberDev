...
import { OMNIDEF } from './tCKResolveBuganizerTicketEnglish_def.js';
import tmpl from './tCKResolveBuganizerTicketEnglish.html';
import tmpl_nds from './tCKResolveBuganizerTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKResolveBuganizerTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
