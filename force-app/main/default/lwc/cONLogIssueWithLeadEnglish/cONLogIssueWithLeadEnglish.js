...
import { OMNIDEF } from './cONLogIssueWithLeadEnglish_def.js';
import tmpl from './cONLogIssueWithLeadEnglish.html';
import tmpl_nds from './cONLogIssueWithLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONLogIssueWithLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
