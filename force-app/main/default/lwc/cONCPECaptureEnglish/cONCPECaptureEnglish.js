...
import { OMNIDEF } from './cONCPECaptureEnglish_def.js';
import tmpl from './cONCPECaptureEnglish.html';
import tmpl_nds from './cONCPECaptureEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCPECaptureEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
