...
import { OMNIDEF } from './cONLogIssueEnglish_def.js';
import tmpl from './cONLogIssueEnglish.html';
import tmpl_nds from './cONLogIssueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONLogIssueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
