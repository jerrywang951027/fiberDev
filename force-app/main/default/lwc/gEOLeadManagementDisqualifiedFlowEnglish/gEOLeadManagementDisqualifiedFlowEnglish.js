...
import { OMNIDEF } from './gEOLeadManagementDisqualifiedFlowEnglish_def.js';
import tmpl from './gEOLeadManagementDisqualifiedFlowEnglish.html';
import tmpl_nds from './gEOLeadManagementDisqualifiedFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class gEOLeadManagementDisqualifiedFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
