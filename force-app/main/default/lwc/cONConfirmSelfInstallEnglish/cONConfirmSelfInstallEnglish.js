...
import { OMNIDEF } from './cONConfirmSelfInstallEnglish_def.js';
import tmpl from './cONConfirmSelfInstallEnglish.html';
import tmpl_nds from './cONConfirmSelfInstallEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONConfirmSelfInstallEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
