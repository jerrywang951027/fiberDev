...
import { OMNIDEF } from './cONScheduleRepairVisitEnglish_def.js';
import tmpl from './cONScheduleRepairVisitEnglish.html';
import tmpl_nds from './cONScheduleRepairVisitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONScheduleRepairVisitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
