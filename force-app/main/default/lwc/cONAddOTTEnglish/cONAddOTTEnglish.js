...
import { OMNIDEF } from './cONAddOTTEnglish_def.js';
import tmpl from './cONAddOTTEnglish.html';
import tmpl_nds from './cONAddOTTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONAddOTTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
