...
import { OMNIDEF } from './lDMProofOfResidenceEnglish_def.js';
import tmpl from './lDMProofOfResidenceEnglish.html';
import tmpl_nds from './lDMProofOfResidenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lDMProofOfResidenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
