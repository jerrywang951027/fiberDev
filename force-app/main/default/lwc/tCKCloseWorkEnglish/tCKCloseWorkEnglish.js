...
import { OMNIDEF } from './tCKCloseWorkEnglish_def.js';
import tmpl from './tCKCloseWorkEnglish.html';
import tmpl_nds from './tCKCloseWorkEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKCloseWorkEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
