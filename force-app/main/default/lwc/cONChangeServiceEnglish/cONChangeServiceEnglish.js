...
import { OMNIDEF } from './cONChangeServiceEnglish_def.js';
import tmpl from './cONChangeServiceEnglish.html';
import tmpl_nds from './cONChangeServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONChangeServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
