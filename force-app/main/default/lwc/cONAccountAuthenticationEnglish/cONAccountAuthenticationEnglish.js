...
import { OMNIDEF } from './cONAccountAuthenticationEnglish_def.js';
import tmpl from './cONAccountAuthenticationEnglish.html';
import tmpl_nds from './cONAccountAuthenticationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONAccountAuthenticationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
