...
import { OMNIDEF } from './cONScheduleAppointmentEnglish_def.js';
import tmpl from './cONScheduleAppointmentEnglish.html';
import tmpl_nds from './cONScheduleAppointmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONScheduleAppointmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
