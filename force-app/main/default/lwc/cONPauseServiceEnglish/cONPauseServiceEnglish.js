...
import { OMNIDEF } from './cONPauseServiceEnglish_def.js';
import tmpl from './cONPauseServiceEnglish.html';
import tmpl_nds from './cONPauseServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONPauseServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
