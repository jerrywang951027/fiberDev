...
import { OMNIDEF } from './profileAuthorizationEnglish_def.js';
import tmpl from './profileAuthorizationEnglish.html';
import tmpl_nds from './profileAuthorizationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class profileAuthorizationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
