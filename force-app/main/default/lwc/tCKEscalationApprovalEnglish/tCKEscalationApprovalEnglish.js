...
import { OMNIDEF } from './tCKEscalationApprovalEnglish_def.js';
import tmpl from './tCKEscalationApprovalEnglish.html';
import tmpl_nds from './tCKEscalationApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKEscalationApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
