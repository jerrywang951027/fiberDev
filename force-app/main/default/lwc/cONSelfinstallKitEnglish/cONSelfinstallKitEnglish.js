...
import { OMNIDEF } from './cONSelfinstallKitEnglish_def.js';
import tmpl from './cONSelfinstallKitEnglish.html';
import tmpl_nds from './cONSelfinstallKitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONSelfinstallKitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
