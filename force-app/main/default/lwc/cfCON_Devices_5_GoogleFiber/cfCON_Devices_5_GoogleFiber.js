import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCON_Devices_5_GoogleFiber extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              registerPubSub() {
                pubsub.register('serviceDeviceChannel', {
                          service_device_channel: this.handleEventAction.bind(this, data.events[0],0)
                      });
