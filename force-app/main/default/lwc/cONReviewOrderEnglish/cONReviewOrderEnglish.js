...
import { OMNIDEF } from './cONReviewOrderEnglish_def.js';
import tmpl from './cONReviewOrderEnglish.html';
import tmpl_nds from './cONReviewOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONReviewOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
