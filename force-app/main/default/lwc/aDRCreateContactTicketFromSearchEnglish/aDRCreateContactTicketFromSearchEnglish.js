...
import { OMNIDEF } from './aDRCreateContactTicketFromSearchEnglish_def.js';
import tmpl from './aDRCreateContactTicketFromSearchEnglish.html';
import tmpl_nds from './aDRCreateContactTicketFromSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aDRCreateContactTicketFromSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
