...
import { OMNIDEF } from './tCKEscalateServiceEnglish_def.js';
import tmpl from './tCKEscalateServiceEnglish.html';
import tmpl_nds from './tCKEscalateServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKEscalateServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
