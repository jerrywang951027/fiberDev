...
import { OMNIDEF } from './cONDisconnectAccountEnglish_def.js';
import tmpl from './cONDisconnectAccountEnglish.html';
import tmpl_nds from './cONDisconnectAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONDisconnectAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
