...
import { OMNIDEF } from './tCKEditTicketEnglish_def.js';
import tmpl from './tCKEditTicketEnglish.html';
import tmpl_nds from './tCKEditTicketEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKEditTicketEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
