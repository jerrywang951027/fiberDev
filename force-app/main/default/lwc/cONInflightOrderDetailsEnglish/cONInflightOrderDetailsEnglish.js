...
import { OMNIDEF } from './cONInflightOrderDetailsEnglish_def.js';
import tmpl from './cONInflightOrderDetailsEnglish.html';
import tmpl_nds from './cONInflightOrderDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONInflightOrderDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
