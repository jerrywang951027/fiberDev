...
import { OMNIDEF } from './lDMAddressReviewEnglish_def.js';
import tmpl from './lDMAddressReviewEnglish.html';
import tmpl_nds from './lDMAddressReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lDMAddressReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
