...
import { OMNIDEF } from './gEOLeadManagementInProgressFlowEnglish_def.js';
import tmpl from './gEOLeadManagementInProgressFlowEnglish.html';
import tmpl_nds from './gEOLeadManagementInProgressFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class gEOLeadManagementInProgressFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
