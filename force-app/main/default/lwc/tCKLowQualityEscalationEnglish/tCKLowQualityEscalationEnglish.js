...
import { OMNIDEF } from './tCKLowQualityEscalationEnglish_def.js';
import tmpl from './tCKLowQualityEscalationEnglish.html';
import tmpl_nds from './tCKLowQualityEscalationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKLowQualityEscalationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
