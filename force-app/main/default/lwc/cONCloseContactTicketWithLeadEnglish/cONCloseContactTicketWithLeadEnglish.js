...
import { OMNIDEF } from './cONCloseContactTicketWithLeadEnglish_def.js';
import tmpl from './cONCloseContactTicketWithLeadEnglish.html';
import tmpl_nds from './cONCloseContactTicketWithLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCloseContactTicketWithLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
