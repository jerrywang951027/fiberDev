...
import { OMNIDEF } from './cPQSubmitOrderEnglish_def.js';
import tmpl from './cPQSubmitOrderEnglish.html';
import tmpl_nds from './cPQSubmitOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQSubmitOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
