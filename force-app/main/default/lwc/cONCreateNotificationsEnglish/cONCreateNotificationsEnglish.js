...
import { OMNIDEF } from './cONCreateNotificationsEnglish_def.js';
import tmpl from './cONCreateNotificationsEnglish.html';
import tmpl_nds from './cONCreateNotificationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONCreateNotificationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
