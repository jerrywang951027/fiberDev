...
import { OMNIDEF } from './cONUpdateSubscriptionEnglish_def.js';
import tmpl from './cONUpdateSubscriptionEnglish.html';
import tmpl_nds from './cONUpdateSubscriptionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONUpdateSubscriptionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
