...
import { OMNIDEF } from './aDRCustomerSearchEnglish_def.js';
import tmpl from './aDRCustomerSearchEnglish.html';
import tmpl_nds from './aDRCustomerSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aDRCustomerSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
