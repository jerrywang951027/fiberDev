...
import { OMNIDEF } from './tCKRescheduleAppointmentEnglish_def.js';
import tmpl from './tCKRescheduleAppointmentEnglish.html';
import tmpl_nds from './tCKRescheduleAppointmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKRescheduleAppointmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
