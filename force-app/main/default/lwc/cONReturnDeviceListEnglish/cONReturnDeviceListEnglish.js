...
import { OMNIDEF } from './cONReturnDeviceListEnglish_def.js';
import tmpl from './cONReturnDeviceListEnglish.html';
import tmpl_nds from './cONReturnDeviceListEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cONReturnDeviceListEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
