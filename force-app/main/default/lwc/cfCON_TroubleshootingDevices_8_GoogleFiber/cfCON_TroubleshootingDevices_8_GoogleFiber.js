import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCON_TroubleshootingDevices_8_GoogleFiber extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfCON_TroubleshootingDevices_8_GoogleFiber';
              @track record;
              ...
              registerPubSub() {
                pubsub.register('serviceAccountChannel', {
                          service_account_channel: this.handleEventAction.bind(this, data.events[0],0)
                      });
