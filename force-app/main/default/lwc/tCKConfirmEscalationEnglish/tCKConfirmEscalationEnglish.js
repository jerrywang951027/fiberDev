...
import { OMNIDEF } from './tCKConfirmEscalationEnglish_def.js';
import tmpl from './tCKConfirmEscalationEnglish.html';
import tmpl_nds from './tCKConfirmEscalationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tCKConfirmEscalationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
